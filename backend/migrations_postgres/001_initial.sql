...
CREATE TABLE IF NOT EXISTS pivot_snapshots (
    ...
    status_code TEXT,
    quality_code TEXT,
    last_activity_ts DOUBLE PRECISION,
    last_seen_ts DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS probe_delay_points (
    ...
    session_id TEXT NOT NULL,
    ts DOUBLE PRECISION NOT NULL,
    latency_sec DOUBLE PRECISION NOT NULL,
    avg_latency_sec DOUBLE PRECISION NOT NULL,
    median_latency_sec DOUBLE PRECISION,
...
CREATE TABLE IF NOT EXISTS cloud2_events (
    ...
    drop_duration_sec DOUBLE PRECISION,
    firmware TEXT,
    event_date TEXT,
    event_json TEXT,
    created_at_ts DOUBLE PRECISION NOT NULL,
